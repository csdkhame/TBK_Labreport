...
<!--- Pickerdate --->
<link rel="stylesheet" type="text/css" href="admin/admin/lab_report_v2/assets_nut/pickerdate/classic.css?v=<?=time();?>" /> 
<link rel="stylesheet" type="text/css" href="admin/admin/lab_report_v2/assets_nut/pickerdate/classic.date.css?v=<?=time();?>" /> 
<script src="admin/admin/lab_report_v2/assets_nut/pickerdate/picker.js?v=<?=time();?>" type="text/javascript"></script>
<script src="admin/admin/lab_report_v2/assets_nut/pickerdate/picker.date.js?v=<?=time();?>" type="text/javascript"></script>
...
?>
<?php include('admin/admin/lab_report_v2/connect_cn.php'); ?>
<style>
	.fixedContainer {
    position: fixed; 
    left: 10px;
...
<script>
    $(document).ready(function() {
        function Search() {
            ...
            var url = 'popup4.php?name=admin/lab_report_v2&file=report_doc_query&date_tran=' + date + '&key_word=' + keyword + '&type=' + type + '&company=' + company_tran+'&user='+'<?=$_SESSION[admin_user];?>';

            var url_cn = '<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=report_doc_query&date_tran=' + date + '&key_word=' + keyword + '&type=' + type + '&company=' + company_tran+"&server=cn"+'&user='+'<?=$_SESSION[admin_user];?>';
...
<script>
    function searchFilter(type_show) {
        ...
        var type = $("#type_order").val();
        var company_tran = $("#company_tran").val();
        var url = 'popup4.php?name=admin/lab_report_v2&file=report_doc_query&date_tran=' + date + '&key_word=' + keyword + '&type=' + type + '&company=' + company_tran + "&type_show=" + type_show+'&user='+'<?=$_SESSION[admin_user];?>';

       var url_cn = '<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=report_doc_query&date_tran=' + date + '&key_word=' + keyword + '&type=' + type + '&company=' + company_tran + "&type_show=" + type_show+"&server=cn"+'&user='+'<?=$_SESSION[admin_user];?>';
...
<script>
    function viewHistory(id,server) {
		...
		if(server==1){
		   var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=report_doc_histroy&id_order=" + id;
		}else{
		   var url = "popup4.php?name=admin/lab_report_v2&file=report_doc_histroy&id_order=" + id;
		}
...
<script>
	function changeDriver(driver_id, order_id, date,server,com,invoice,type_call){
		...
		if(type_call=='action'){
			...
			if(server==1){
	  	var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=driver_change_list&call=action";
			}else{
		var url = "popup4.php?name=admin/lab_report_v2&file=driver_change_list&call=action";
			}
			...
			if(server==1){
	  	var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=driver_change_list&call=view_history_change_driver";
			}else{
		var url = "popup4.php?name=admin/lab_report_v2&file=driver_change_list&call=view_history_change_driver";
			}
		}
		$.post(url, {
	            driver_id: driver_id,
...
<script>
    function driverPro(driver_id, nickname, date,server) {
		...
		if(server==1){
  	var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=driver_detail";
		}else{
	var url = "popup4.php?name=admin/lab_report_v2&file=driver_detail";
		}
    ...
    function viewDetail(id_order, title,server) {
        ...
        $("#detail_show").html('<div align="center"><img src="iconstatus/loader.gif"/></div>');
		if(server==1){
  var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=report_doc_detail&id_order=" + id_order + "&date_tran=" + date+"&server="+server;
		}else{
  var url = "popup4.php?name=admin/lab_report_v2&file=report_doc_detail&id_order=" + id_order + "&date_tran=" + date+"&server="+server;
		}
...
if(server==1){
		   var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=update_status&action=approve&status=" + status+"&user="+user;
}else{
		   var url = "popup4.php?name=admin/lab_report_v2&file=update_status&action=approve&status=" + status+"&user="+user;
}
...
function(){
    ...
    function update_lab_meet(id, status, vc,server,user,orderid) {
		...
		if(server==1){
		   var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=update_status&action=meet&status=" + status+"&user="+user+'&orderid='+orderid;
		}else{
		    var url = "popup4.php?name=admin/lab_report_v2&file=update_status&action=meet&status=" + status+"&user="+user+'&orderid='+orderid;
		}
           var lat = $('#lat').val();
			var lng = $('#lng').val();
...
<script>
    function update_approve_all(num,server,user) {
		...
		if(server==1){
		   var url = "<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=update_status&action=all&server="+server+"&user="+user;
		     var data_form = $('#approve_all_cn').serialize();
		   
		}else{
		   var url = "popup4.php?name=admin/lab_report_v2&file=update_status&action=all&server="+server+"&user="+user;
...
<!-- popup -->
<link rel="stylesheet" href="admin/admin/lab_report_v2/assets_nut/craftpip/css/bootstrap-fullscreen-select.css" />
<style>
.popup-open {
    overflow: hidden;
} 
...
<script>
	...
	$('#select_company_mobile').change(function(){
		...
		if($('#server_change_driver').val()==1){
			...
			var url = '<?php echo $ip_cn;?>popup4.php?name=admin/lab_report_v2&file=driver_list&com='+id_com+'&driver_id='+driver_old+'&view=mobile';
		}else{
			var url = 'popup4.php?name=admin/lab_report_v2/query&file=driver_list&com='+id_com+'&driver_id='+driver_old+'&view=mobile';
		}
		console.log(url);
...
//			alert(com);
	...
	$('#submit_change_driver').click(function(){
		...
		if($('#server_change_driver').val()==1){
			var url = '<?php echo $ip_cn;?>admin/admin/lab_report_v2/update_status.php?action=change_driver&drivername='+driver_new+'&old_drivername='+driver_old+'&order_id='+order_id+'&old_carno='+old_carno+'&carno='+carno+'&posted='+posted+'&num_of_report='+num_of_report;
		}else{
			var url = 'admin/admin/lab_report_v2/update_status.php?action=change_driver&drivername='+driver_new+'&old_drivername='+driver_old+'&order_id='+order_id+'&old_carno='+old_carno+'&carno='+carno+'&posted='+posted+'&num_of_report='+num_of_report;
		}
...
<script>
	function CheckIn(invoice,orderid){
		...
		var lat = $('#lat').val();
		var lng = $('#lng').val();
		var url = 'popup4.php?name=admin/lab_report_v2/special&file=checkin_place&lat='+lat+'&lng='+lng+'&invoice='+invoice+'&orderid='+orderid;
		$.post( url, function( data ) {
//			console.log(data);
		  $( "#detail_show" ).html( data );
